...
if (Brews.find().count() === 0 && Meteor.isServer) {
  _.each([
    ...
    },
    {
      ...
      type: 'Ale',
      abv: 0.049,
      notes: "Golden honey in colour, APA beer has a complex aroma - a smoky, peaty blend of sweet green apples and vanilla - and a beautifully balanced flavour which is crisp, smooth and incredibly refreshing.\n\nVarieties of are Hop are selected to create the character and provide a clean and delicious hop aroma."
    },
    {
      code: 'YA',
      name: 'Yankee Ale',
      ...
      type: 'Ale',
      abv: 0.040,
      notes: "This beer is the quintessential Australian lager and with each mouthful you imbibe has a great mouthfeel! At 4% alcohol and with the main point of difference that this is a truly Certified Organic beer, this refreshing lager tastes like real beer should!\n\nThis beer has created this uniquely appealing beer to please even the most demanding connoisseur, suiting both the special occasion requiring something different and the relaxed drink at home."
    },
    {
      code: 'ABC',
